//! The body limit of `/api/admin/v1`: 64 KiB, what a sign-in needs; relayed bodies are the
//! server's to limit.
...
/// The body limit of the routes the admin server reads a body of: 64 KiB.
pub const API_BODY_LIMIT_BYTES: usize = 64 * 1024;
